// Project path: src/components/admin/purchase-orders/WarningsBadge.tsx
//
// warnings[] is assumed to be plain strings (see spec §15) — no severity
...
export function WarningsBadge({ warnings }: WarningsBadgeProps) {
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {t("purchaseOrders.warnings.count", { count: warnings.length })}
      </button>
