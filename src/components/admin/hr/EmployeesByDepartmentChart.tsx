// Intended path: src/components/admin/hr/EmployeesByDepartmentChart.tsx
...
export function EmployeesByDepartmentChart({ data, isLoading }: Props) {
  ...
  return (
    <div className="bg-panel border border-hairline rounded-lg p-4 shadow-elevation-1">
      <h3 className="text-sm font-medium text-ink-primary mb-3">
        {t('hr.overview.employeesByDepartment.title')}
      </h3>
      ...
      {isLoading ? (
        ...
        <EmptyState
          title={t('hr.overview.employeesByDepartment.emptyTitle')}
          description={t(
            'hr.overview.employeesByDepartment.emptyDescription'
          )}
        />
      ) : (
          ...
          >
            ...
            <Tooltip
              ...
              formatter={(value) => [
                ...
                t('hr.overview.employeesByDepartment.countLabel'),
              ]}
            />
